...
export const ENEMY_TYPES = {
  shambler: {
    key: 'shambler', name: 'Shambler', epithet: 'Lolo Vokatra · The Risen Dead',
    lore: 'The restless dead rising from the vaults of Anjanahary. The Rift\u2019s emerald breath knits ancient bones back into hunger \u2014 slow, relentless, and clawing through the granite crypts.',
    threat: 1, hp: 30, speed: 74, r: 15, dmg: 10, score: 10,
    color: '#79c94a', glow: '#54d44a', unlock: 1,
  },
  wraith: {
    key: 'wraith', name: 'Wraith', epithet: 'Angatra · Restless Spirit',
    lore: 'An Angatra born from ancestral grief in the highland necropolis. It drifts through granite walls and family tombs, drinking warmth from the living until only frost remains.',
    threat: 2, hp: 20, speed: 128, r: 13, dmg: 8, score: 15,
    color: '#7be9ff', glow: '#7be9ff', unlock: 2,
  },
  hound: {
    key: 'hound', name: 'Hellhound', epithet: 'Alika Masiaka · Tomb Stalker',
    lore: 'Feral beasts corrupted by rift energy in the red laterite catacombs beneath Anjanahary. They stalk between the vaults in burning patience, then charge with blistering speed.',
    threat: 2, hp: 26, speed: 120, r: 13, dmg: 12, score: 20,
    color: '#ff9d3d', glow: '#ff6a2e', unlock: 3,
  },
  vampire: {
    key: 'vampire', name: 'Vampire', epithet: 'Mpitsentsitra Liana · Night Aristocrat',
    lore: 'Ancient colonial entities interred in the 1880 Fasam-bahiny sector. Decades in the stone crypts have only honed their speed \u2014 they glide effortlessly between rifle fire and granite tombs.',
    threat: 3, hp: 55, speed: 112, r: 14, dmg: 14, score: 30,
    color: '#ff2e4d', glow: '#b06cff', unlock: 5,
  },
  banshee: {
    key: 'banshee', name: 'Banshee', epithet: 'Matotoa · The Wailing Echo',
    lore: 'A shrieking Matotoa lingering above the Carré Militaire. She hovers at distance and screams piercing spirit shards across the cobblestone cemetery avenues.',
    threat: 3, hp: 45, speed: 86, r: 14, dmg: 8, score: 40,
    color: '#cfa9ff', glow: '#b06cff', unlock: 7,
  },
  abomination: {
    key: 'abomination', name: 'Abomination', epithet: 'Biby Goavana · Fused Colossus',
    lore: 'A massive monstrosity fused from the remains of forgotten tombs. It strides through gunfire and shatters stone steles; when it falls, the dead rise anew beside it.',
